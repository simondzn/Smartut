...
function addContact() {
    ...
    $('#ar_feed').append('<article id="' + id + '"><div class="contact"><p href="tel:" class="show_note">' + name + "   " + adress + "   " + phone + '</p><button onclick="removecont(' + id + ')"><i class="fa fa-trash-o"></i></button>').fadeIn(500);
    $('input').filter('[class*=client_set]').val('');
